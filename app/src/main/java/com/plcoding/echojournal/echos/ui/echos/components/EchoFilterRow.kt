...
import com.plcoding.echojournal.core.ui.design.chips.MultiChoiceChip
...
import com.plcoding.echojournal.echos.ui.echos.EchosAction
            ...
            dropDownMenu = {
                SelectableDropDownOptionsMenu(
                    ...
                    onItemClick = { selectable ->
                        onAction(EchosAction.OnFilterByMoodClick(selectable.item))
                    },
            ...
            dropDownMenu = {
                if (topics.isEmpty()) {
                    ...
                    SelectableDropDownOptionsMenu(
                        ...
                        key = { it },
                        onItemClick = { selectable ->
                            onAction(EchosAction.OnFilterByTopicClick(selectable.item))
                        },
                        dropDownOffset = dropDownOffset,
                        maxDropDownHeight = dropDownMaxHeight,
                        leadingIcon = {
